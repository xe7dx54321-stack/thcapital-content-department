# 微信订阅巡检记录 | 2026-05-21 13:15 CST

## 任务说明
- 任务类型：微信订阅池 bootstrap/巡检（cron 触发 13:10）
...
- 15/15 个账号 source packet 全部写盘（`02_topic_radar/source_packets/20260521__source__wechat__*.md`）
- 订阅池 15 个账号全部在册，盘面完整
...
Jina search 全天对微信公众号内容（`site:mp.weixin.qq.com`）收录质量系统性偏低，连续多日 cron 运行均返回 0 篇文章。这是工具层限制，非账号/订阅池问题。
...
market-scout runtime | 微信订阅池 bootstrap | 2026-05-21 13:15 CST