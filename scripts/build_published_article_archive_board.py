#!/usr/bin/env python3
"""Build published article archive board."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Build published article archive board.")
    ...
    if args.json:
        ...
        print("Published Article Archive Board")
        print("===============================")
