...
def main() -> int:
    ...
    planned = [
        ...
        ("llm_proponent_reviews", [sys.executable, "scripts/run_llm_proponent_reviews.py", "--mode", "dry_run"]),
        ("llm_critic_reviews", [sys.executable, "scripts/run_llm_critic_reviews.py", "--mode", "dry_run"]),
        ("llm_judge_gate", [sys.executable, "scripts/run_llm_judge_gate.py", "--mode", "dry_run"]),
        ("llm_rewrite_suggestions", [sys.executable, "scripts/run_llm_rewrite_suggestions.py", "--mode", "dry_run"]),
