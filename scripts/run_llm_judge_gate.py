#!/usr/bin/env python3
"""Run LLM Judge Agent v1 sidecar gate."""
...
from content_system.llm_judge_agent import build_llm_judge_gate_report, report_to_dict, write_llm_judge_gate_report  # noqa: E402
from content_system.paths import get_project_paths  # noqa: E402


def main() -> int:
    parser = argparse.ArgumentParser(description="Run LLM Judge Agent v1.")
