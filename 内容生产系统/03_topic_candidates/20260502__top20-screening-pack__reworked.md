...
### 18. 腾讯增持游戏科学至24%：《黑神话：悟空》开发商获唯一外部投资

- `topic_key`: `tx__game_science__24pct__20260501`
- `title`: `腾讯增持游戏科学至24%，成唯一外部投资方`
- `primary_platform`: `微信（极客公园）`
- `published_at`: `2026-05-01`
- `original_link`: `https://mp.weixin.qq.com/s/8-C0-QrX5_8qd87GxFt6qg`
- `source_packet`: `20260502_121306__wechat_geekpark_iphone_air_pocket_24__source-packet.md`
- `deep_article`: `20260502_121550__deep-article.md`
- `score_total`: `15/30`
- `score_breakdown`: `一手性=2|传播性=2|破圈性=3|赛道匹配=1|可延展性=3|数据硬度=3|视觉素材=2|平台适配=2|时效窗口=2|讨论度=1`
- `signal_summary`: 5月1日工商变更：游戏科学（深圳市游科互动科技有限公司）完成股权调整，英雄游戏退出，腾讯从5%（2021年初始入股）增持至24%，成为唯一外部投资方。游戏科学为《黑神话：悟空》开发商。
- `why_in_top20`: （1）硬数据：工商变更，5月1日，时间极新；（2）破圈性：游戏+AI+投资三圈交汇；（3）腾讯尊重创意、游戏科学保持独立运营——有内容张力；（4）24%持股超过了一般财务投资，有战略含义；（5）Boost.space v5 得分12/30，本替代对象数据更硬
- `reinforcement_notes`: 本轮有限强化替换：旧 #18 Boost.space v5（score 12/30，TrendHunt来源，官网待核实）→ 腾讯/游戏科学（score 15/30，一手工商数据，极客公园来源，跨游戏/AI/投资三圈）
- `visual_assets`: 微信文章14张配图；游戏科学官网产品截图待补
- `risks`: 游戏行业政策风险；腾讯战略意图不透明；内容工厂视角不是投研，不做持股比例投资建议
