...
- `generated_at`: `2026-03-28 22:45:59 CST`
- `date`: `2026-03-28`
- `sample_count`: `8`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 量子位 | 疯狂小扎边裁员边给高管发钱！元宇宙硬件成重灾区 | 2026-03-27 17:02:33 CST | 3330 | 7 | 16 | [原文](https://mp.weixin.qq.com/s/9zcHAv9sZ2sveMawEgBhsA) |
| 2 | 量子位 | 国产玩家亮剑世界模型！把全模态卷到顶后，天工AI不藏了 | 2026-03-27 21:49:20 CST | 1541 | 18 | 15 | [原文](https://mp.weixin.qq.com/s/lNdMYYhM3bYHPvLD7Bkr1A) |
| 3 | 量子位 | 龙虾安全被3层硬核架构焊死了！一份面向开发者的硬核生存指南 | 2026-03-27 17:02:33 CST | 6050 | 4 | 30 | [原文](https://mp.weixin.qq.com/s/SiYE61NO_m1q8MjTzvK5qQ) |
| 4 | 机器之心 | 不止Deep，更要Wide：清华、无问芯穹发布多智能体系统WideSeek-R1，4B模型比肩671B模型！ | 2026-03-27 12:01:55 CST | 4849 | 12 | 0 | [原文](https://mp.weixin.qq.com/s/qgGe51RcwJxkZ25DxQEpBA) |
| 5 | 极客公园 | 开放 Siri，苹果决定打开万亿「AI 生态」 | 2026-03-27 13:31:11 CST | 3259 | 6 | 0 | [原文](https://mp.weixin.qq.com/s/aJZKf9WefHQDwFQiYgVPGw) |
| 6 | 极客公园 | 「Context 才是新操作系统」：从大疆、云鲸离开后，他要做 Agent Computer | 2026-03-27 11:04:57 CST | 10000 | 6 | 0 | [原文](https://mp.weixin.qq.com/s/UbVodOvPprScY4VK4bVrYQ) |
| 7 | Founder Park | 对话贝陪科技：好的 AI 陪伴产品，应该让 AI 少说话 | 2026-03-26 19:43:25 CST | 16296 | 7 | 0 | [原文](https://mp.weixin.qq.com/s/NOEEN8SDpwMT_K0ATx3FPg) |
| 8 | Founder Park | 黄仁勋：芯片公司的时代已经结束了，现在是 AI 工厂的时代 | 2026-03-25 20:35:15 CST | 16796 | 4 | 0 | [原文](https://mp.weixin.qq.com/s/wwM7dlz1s0y8N8Ff8g6p0A) |
...
- `量子位｜疯狂小扎边裁员边给高管发钱！元宇宙硬件成重灾区`：梦瑶 发自 凹非寺 / 量子位 | 公众号 QbitAI
- `量子位｜国产玩家亮剑世界模型！把全模态卷到顶后，天工AI不藏了`：一水 发自 凹非寺 / 量子位 | 公众号 QbitAI
- `量子位｜龙虾安全被3层硬核架构焊死了！一份面向开发者的硬核生存指南`：允中 发自 凹非寺 / 量子位 | 公众号 QbitAI
...
- `Founder Park｜对话贝陪科技：好的 AI 陪伴产品，应该让 AI 少说话`：同样是儿童陪伴产品，贝陪科技的产品「可豆陪陪」有点不一样。 / 毛绒娃娃没有 AI 能力，智能交互都在娃娃的智能眼镜上；押注纯语音，而是做了大量 NFC 卡牌，涵盖故事播放、探案游戏等等，并将 NFC 卡牌视作孩子的 AI 入口。
- `Founder Park｜黄仁勋：芯片公司的时代已经结束了，现在是 AI 工厂的时代`：最擅长做深度访谈的 Lex Fridman 采访黄仁勋，肯定是值得看的。 / 对谈中，老黄聊了聊他对于现在整个 AI 行业逻辑的理解：AI 已经不是一种软件功能了，更像是工业产品。同样，OpenClaw 这类 Agent 不再是聊天工具，是一种持续运行的算力消耗。
...
- `量子位`：全文 `image_count=7`，首图位置 `16`，说明图片被拿来承担“对象识别 / 证据锚点 / 节奏换气”，而不是纯装饰。
- `量子位`：全文 `image_count=18`，首图位置 `15`，说明图片被拿来承担“对象识别 / 证据锚点 / 节奏换气”，而不是纯装饰。
- `量子位`：全文 `image_count=4`，首图位置 `30`，说明图片被拿来承担“对象识别 / 证据锚点 / 节奏换气”，而不是纯装饰。
